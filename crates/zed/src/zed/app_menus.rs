...
// Jamu: Minimal menus for agent-only mode
fn minimal_agent_menus(_cx: &mut App) -> Vec<Menu> {
    ...
    vec![
        Menu {
            name: "Jamu".into(),
            items: vec![
                MenuItem::action("About Jamu", zed_actions::About),
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Jamu", super::Hide),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Others", super::HideOthers),
                #[cfg(target_os = "macos")]
                MenuItem::action("Show All", super::ShowAll),
                MenuItem::separator(),
                MenuItem::action("Quit Jamu", Quit),
            ],
        },
        Menu {
            name: "Edit".into(),
        ...
        Menu {
            name: "Help".into(),
            items: vec![
                MenuItem::action("Documentation", zed_actions::OpenBrowser {
                    url: "https://jamu.app/docs".into(),
                }),
            ],
        },
    ]
