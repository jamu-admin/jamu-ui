    ...
    pub fn map_event(
        ...
        match event {
            ...
            Event::MessageStart { message } => {
                // JAMU DEBUG: Log the model that Anthropic reports in the response
                log::info!(
                    "🎵 JAMU API RESPONSE: model={}, id={}, input_tokens={:?}, output_tokens={:?}",
                    message.model,
                    message.id,
        ...
        if self.load_credentials_task.is_some() {
            ...
            v_flex()
                ...
                .child(Label::new(format!("To use {}, you need to add an API key. Follow these steps:", match &self.target_agent {
                    ConfigurationViewTargetAgent::ZedAgent => "Jamu's agent with Anthropic".into(),
