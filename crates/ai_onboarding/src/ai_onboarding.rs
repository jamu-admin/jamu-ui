...
impl ZedAiOnboarding {
    ...
    fn render_sign_in_disclaimer(&self, _cx: &mut App) -> AnyElement {
        ...
        v_flex()
            .gap_1()
            .child(Headline::new("Welcome to Jamu AI"))
            .child(
                Label::new("Sign in to try Jamu Pro for 14 days, no credit card required.")
                    .color(Color::Muted)
                    .mb_2(),
            )
            .child(PlanDefinitions.pro_plan(true, false))
            .child(
                Button::new("sign_in", "Try Jamu Pro for Free")
                    .disabled(signing_in)
                    .full_width()
    ...
    fn render_pro_plan_state(&self, is_v2: bool, _cx: &mut App) -> AnyElement {
        v_flex()
            .gap_1()
            .child(Headline::new("Welcome to Jamu Pro"))
            .child(
